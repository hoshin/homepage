...
var lookupPicture = function lookupPicture(location, document) {
    if (location.match(/^(?:(?:https?|ftp):\/\/)(?:\S+(?::\S*)?@)?(?:(?!10(?:\.\d{1,3}){3})(?!127(?:\.\d{1,3}){3})(?!169\.254(?:\.\d{1,3}){2})(?!192\.168(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z0-9]+-?)*[a-z0-9]+)(?:\.(?:[a-z0-9]+-?)*[a-z0-9]+)*(?:\.(?:[a-z]{2,})))(?::\d{2,5})?(?:\/[^\s]*)?$/)) {
        ...
        var pictureElement = document.getElementById(location);
        if (pictureElement) {
...
exports.default = {
    lookupPicture: lookupPicture, getDocument: getDocument
};
...
var _AnnexManager = __webpack_require__(5);

var _AnnexManager2 = _interopRequireDefault(_AnnexManager);

var _AssignmentsManager = __webpack_require__(6);

var _AssignmentsManager2 = _interopRequireDefault(_AssignmentsManager);

var _AcademicManager = __webpack_require__(4);

var _AcademicManager2 = _interopRequireDefault(_AcademicManager);

var _AboutManager = __webpack_require__(3);

var _AboutManager2 = _interopRequireDefault(_AboutManager);

var _HeadersManager = __webpack_require__(7);
...
var Rezume = function () {
    function Rezume(options, resumeData, assignments, document) {
        _classCallCheck(this, Rezume);

        this.annexManager = new _AnnexManager2.default(_utils2.default.getDocument);
        this.academicManager = new _AcademicManager2.default();
        this.aboutManager = new _AboutManager2.default();
        ...
        this.resumeData = _lodash2.default.merge({}, resumeData, assignments[0].resumeData);
        this.updateCVSelector(assignments, document);
        this.assignmentsManager = new _AssignmentsManager2.default(this.assignments);
        this.headersManager = new _HeadersManager2.default(this.assignments.expectedHeaders);
    }

    _createClass(Rezume, [{
        key: 'selectorChange',
        value: function selectorChange() {
            var currentDocument = _utils2.default.getDocument();
            var selectorValue = currentDocument.getElementById('cv_selector').value;
            ...
            this.resumeData = _lodash2.default.merge({}, this._originalResumeData, this.assignmentsList[selectorValue].resumeData);
            this.headersManager.updateHeadersData(this.assignments.expectedHeaders, this.resumeData);
            this.render(currentDocument);
        }
    }, {
        key: 'updateCVSelector',
        value: function updateCVSelector(assignmentsArray, document) {
            if (document) {
                var selector = document.getElementById('cv_selector');
                selector.setAttribute('style', 'display:block');

                assignmentsArray.forEach(function (assignmentsList, key) {
        ...
        value: function render() {
            var document = _utils2.default.getDocument();
            var resumeData = this.resumeData;
            var resumeOptions = this.options;
...
var AboutManager = function () {
    function AboutManager() {
        _classCallCheck(this, AboutManager);
    }

    _createClass(AboutManager, [{
        key: 'renderAbout',
        value: function renderAbout(aboutData) {
            var document = _utils2.default.getDocument();
...
var AcademicManager = function () {
    function AcademicManager() {
        _classCallCheck(this, AcademicManager);
    }

    _createClass(AcademicManager, [{
        key: 'renderAcademic',
        value: function renderAcademic(resumeData) {
            var document = _utils2.default.getDocument();
...
exports.default = AcademicManager;
...
var AnnexManager = function () {
    function AnnexManager() {
        _classCallCheck(this, AnnexManager);
    }

    _createClass(AnnexManager, [{
        key: 'renderAnnex',
        value: function renderAnnex(resumeData) {
            var _this = this;

            var document = _utils2.default.getDocument();
            var annexData = resumeData.annex;
            ...
            if (annexData.skills) {
                ...
                var skillSectionsToRender = Object.keys(annexData.skills).filter(function (skill) {
                    return skill !== 'title';
                });
                skillSectionsToRender.forEach(function (skillSectionToRender, index) {
                    _this.renderAnnexSkillsSection(resumeData, skillSectionToRender);
                    if (index % 2 === 1 && index + 1 < skillSectionsToRender.length) {
                        _this.addSkillsDivider(document);
                    }
                });
            }
        ...
        key: 'addSkillsDivider',
        value: function addSkillsDivider(document) {
            var skillsSectionDOM = document.getElementById('skillsContent');
            var separator = document.createElement('div');
            separator.setAttribute('class', 'divider');
            skillsSectionDOM.append(separator);
        }
    }, {
        key: 'renderAnnexBigSection',
        value: function renderAnnexBigSection(resumeData, sectionName) {
            var document = _utils2.default.getDocument();
        ...
        key: 'renderAnnexSkillsSection',
        value: function renderAnnexSkillsSection(resumeData, skillSectionName) {
            var document = _utils2.default.getDocument();

            var _createDOMSkillSectio = this.createDOMSkillSection(skillSectionName, resumeData),
                skillSectionDOM = _createDOMSkillSectio.skillSectionDOM,
                skillsSectionListDOM = _createDOMSkillSectio.skillsSectionListDOM;
        ...
        key: 'createDOMSkillSection',
        value: function createDOMSkillSection(skillSectionName, resumeData) {
            var document = _utils2.default.getDocument();

            var skillSectionDOM = document.createElement('div');
            skillSectionDOM.setAttribute('class', 'bloc bloc-competence');

            var skillsSectionTitleDOM = document.createElement('h2');
            ...
            var skillsSectionListDOM = document.createElement('ul');
            ...
            return { skillSectionDOM: skillSectionDOM, skillsSectionListDOM: skillsSectionListDOM };
        }
    }, {
        key: 'appendItemsToDOMList',
        value: function appendItemsToDOMList(skillsFromResumeData, DOMElementToAppendTo) {
            skillsFromResumeData.forEach(function (skill) {
                var otherSkillItem = _utils2.default.getDocument().createElement('li');
...
var AssignmentsManager = function () {
    function AssignmentsManager(assignments) {
        _classCallCheck(this, AssignmentsManager);

        this.assignments = assignments;
    }

    _createClass(AssignmentsManager, [{
        key: 'renderAssignments',
        value: function renderAssignments(resumeData, resumeOptions, sectionIdPrefix) {
            var _this = this;

            var document = _utils2.default.getDocument();
            var resumeDataAssignmentsSection = resumeData[sectionIdPrefix + 'Assignments'];
            ...
            resumeDataAssignmentsSection.list.forEach(function (assignmentName) {
                if (_this.assignments[assignmentName]) {
                    _this.appendAssignmentToList(_this.assignments[assignmentName], resumeOptions.showKeywords, relevantAssignmentsListContainer);
                }
            });
        }
    }, {
        key: 'updateAssignmentsData',
        value: function updateAssignmentsData(newAssignments) {
            this.assignments = newAssignments;
        }
    }, {
        key: 'appendAssignmentToList',
        value: function appendAssignmentToList(assignment, showKeywords, relevantAssignmentsListContainer) {
            var document = _utils2.default.getDocument();
        ...
        key: 'createAssignmentDescription',
        value: function createAssignmentDescription(assignment, showKeywords) {
            var document = _utils2.default.getDocument();
        ...
        key: 'createAssignmentLogoFrame',
        value: function createAssignmentLogoFrame(assignment) {
            var document = _utils2.default.getDocument();
            ...
            assignmentImage.setAttribute('src', _utils2.default.lookupPicture(assignment.logo, document));
...
exports.default = AssignmentsManager;
...
var HeadersManager = function () {
    function HeadersManager(givenExpectedHeaders) {
        _classCallCheck(this, HeadersManager);
    ...
    _createClass(HeadersManager, [{
        key: 'updateHeadersData',
        value: function updateHeadersData(assignmentsData) {
            this.expectedHeaders = assignmentsData;
        }
    }, {
        key: 'renderHeader',
        value: function renderHeader(resumeData) {
            var document = _utils2.default.getDocument();
            ...
            Object.keys(resumeData.header).forEach(function (optionName) {
                if (optionName === 'picture') {
                    document.getElementById('picture').setAttribute('src', _utils2.default.lookupPicture(resumeData.header['picture'], document));
                } else if (optionName === 'twitter') {
                    var twitterElement = document.getElementById(optionName);
                    ...
                    var emailElement = document.getElementById(optionName);
                    ...
                    var githubElement = document.getElementById(optionName);
        ...
        key: 'hideUnspecifiedHeaders',
        value: function hideUnspecifiedHeaders(resumeDataHeaderElements) {
            var document = _utils2.default.getDocument();
            var validHeaders = _lodash2.default.intersection(this.expectedHeaders, resumeDataHeaderElements);

            validHeaders.forEach(function (validHeaderElement) {
...
var _rezume = __webpack_require__(2);

window.Rezume = _rezume.Rezume;
